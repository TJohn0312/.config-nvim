...
keymap("n", "<C-q>", "<cmd>BufferLineCloseLeft<cr> <cmd>BufferLineCloseRight<CR>", opts)
--%bd = close all, %bw = force close all, e# = open last, closeRight
-- :BufferLinePick<CR>
...
-- Obsidian follow link under cursor with gf
